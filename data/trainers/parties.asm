...
FalknerGroup:
	...
	db  13, GLIGAR,		POISON_STING, MUD_SLAP, WING_ATTACK, NO_MOVE
	db	13, NATU,		MUD_SLAP, NIGHT_SHADE, PECK, NO_MOVE
	db  14, NOCTOWL,	TACKLE, MUD_SLAP, PECK, THIEF
	db -1 ; end

WhitneyGroup:
	; WHITNEY (1)
	db "WHITNEY@", TRAINERTYPE_ITEM_MOVES
	db 26, GIRAFARIG, NO_ITEM, STOMP, CONFUSION, ATTRACT, BEAT_UP
	db 27, STANTLER,  NO_ITEM, BITE, STOMP, ATTRACT, HYPNOSIS 
	db 27, CLEFABLE,  SCOPE_LENS, DOUBLESLAP, ATTRACT, LIGHT_SCREEN, METRONOME
	db 28, MILTANK,   LEFTOVERS, ROLLOUT, ATTRACT, DEFENSE_CURL, MILK_DRINK
	db -1 ; end

BugsyGroup:
	; BUGSY (1)
	db "BUGSY@", TRAINERTYPE_ITEM_MOVES
	db 22, LEDIAN,     NO_ITEM, COMET_PUNCH, LIGHT_SCREEN, REFLECT, FURY_CUTTER
	db 22, ARIADOS,    NO_ITEM,SPIDER_WEB, NIGHT_SHADE, POISON_STING, NO_MOVE
	db 23, HERACROSS,	NO_ITEM,HORN_ATTACK, FURY_CUTTER, CURSE, ROCK_SMASH
	db 24, SCIZOR,    METAL_COAT, BULLET_PUNCH, PURSUIT, FURY_CUTTER, AGILITY
	db -1 ; end

MortyGroup:
	; MORTY (1)
	db "MORTY@", TRAINERTYPE_ITEM_MOVES
	db 32, GENGAR, SPELL_TAG,    THUNDERBOLT, SHADOW_BALL, ICE_PUNCH, PSYCHIC_M
	db 32, NINETALES, NO_ITEM,    SHADOW_BALL, FLAMETHROWER, CONFUSE_RAY, SUBSTITUTE
	db 33, MAROWAK, THICK_CLUB,   BONEMERANG, ANCIENTPOWER, HEADBUTT, SWORDS_DANCE
	db 34, MISDREAVUS, LEFTOVERS,  SHADOW_BALL, CONFUSE_RAY, PAIN_SPLIT, NIGHT_SHADE
	db -1 ; end

PryceGroup:
	; PRYCE (1)
	db "PRYCE@", TRAINERTYPE_ITEM_MOVES
	db 48, SNEASEL,		FOCUS_BAND, ICY_WIND, DIG, BEAT_UP, ROCK_SLIDE
	db 48, DELIBIRD,	SHARP_BEAK, FLY, ICE_BEAM, SWAGGER, ATTRACT
	db 49, CLOYSTER,	MYSTIC_WATER, SPIKE_CANNON, REST, AMNESIA, SLEEP_TALK
	db 49, DEWGONG,    LEFTOVERS, SLEEP_TALK, CURSE, AURORA_BEAM, REST
	db 49, AMPHAROS,	QUICK_CLAW, THUNDER_WAVE, LIGHT_SCREEN, THUNDERBOLT, REFLECT
	db 50, PILOSWINE,  MIRACLEBERRY, ICY_WIND, TAKE_DOWN, CURSE, BLIZZARD
	db -1 ; end

JasmineGroup:
	; JASMINE (1)
	db "JASMINE@", TRAINERTYPE_ITEM_MOVES
	db 45, MAGNETON,	QUICK_CLAW, THUNDERBOLT, REST, SLEEP_TALK, THUNDER_WAVE
	db 44, BLASTOISE,	MYSTIC_WATER, RAIN_DANCE, ICE_BEAM, BUBBLEBEAM, IRON_TAIL
	db 45, SKARMORY,	FOCUS_BAND, SPIKES, REST, TOXIC, WHIRLWIND
	db 44, VAPOREON,	BRIGHTPOWDER, SURF, REST, RAIN_DANCE, SLEEP_TALK
	db 46, STEELIX,		LEFTOVERS, EARTHQUAKE, SANDSTORM, CURSE, IRON_TAIL
	db -1 ; end

ChuckGroup:
	; CHUCK (1)
	db "CHUCK@", TRAINERTYPE_ITEM_MOVES
	db 43, DONPHAN,		LEFTOVERS,	ANCIENTPOWER, DIG, RAPID_SPIN, CURSE
	db 43, PRIMEAPE,	BERSERK_GENE, ROCK_SLIDE, BEAT_UP, KARATE_CHOP, COMET_PUNCH
	db 44, HITMONTOP,	KINGS_ROCK,	TRIPLE_KICK, PURSUIT, AGILITY, ROLLING_KICK
	db 44, HERACROSS,	BLACKBELT_I, PIN_MISSILE, REVERSAL, DYNAMICPUNCH, CURSE
	db 45, FERALIGATR,  MIRACLEBERRY, BITE, MIND_READER, SURF, DYNAMICPUNCH
	db -1 ; end

ClairGroup:
	; CLAIR (1)
	db "CLAIR@", TRAINERTYPE_ITEM_MOVES
	db 52, YANMA,		KINGS_ROCK, TWISTER, SUPERSONIC, WING_ATTACK, DRAGONBREATH
	db 52, AMPHAROS,	MAGNET, THUNDER_WAVE, THUNDERBOLT, LIGHT_SCREEN, DRAGONBREATH
	db 53, LAPRAS,		LEFTOVERS, REST, SLEEP_TALK, BLIZZARD, DRAGONBREATH
	db 53, RHYDON,		BERSERK_GENE, CRUNCH, ROCK_SLIDE, ANCIENTPOWER, EARTHQUAKE
	db 53, DRAGONAIR,	DRAGON_FANG, THUNDER_WAVE, ICE_BEAM, THUNDERBOLT, DRAGONBREATH
	db 54, KINGDRA,		MIRACLEBERRY, EARTHQUAKE, OCTAZOOKA, HYPER_BEAM, DRAGONBREATH
	db -1 ; end
...
Rival1Group:
	...
	db 31, HAUNTER,    NIGHT_SHADE, HYPNOSIS, MEAN_LOOK, CURSE
	db 32, MAGNETON,  THUNDER_WAVE, THUNDERSHOCK, SUPERSONIC, SONICBOOM
	db 33, GOLBAT,      LEECH_LIFE, WING_ATTACK, BITE, CONFUSE_RAY
	db 32, 	PERSIAN,	BITE, PAY_DAY, SWIFT, SWAGGER 
	db 31, BAYLEEF,    SYNTHESIS, ANCIENTPOWER, RAZOR_LEAF, POISONPOWDER
	db -1 ; end
	...
	db 33, GOLBAT,      LEECH_LIFE, WING_ATTACK, BITE, CONFUSE_RAY
	db 32, 	PERSIAN,	BITE, PAY_DAY, SWIFT, SWAGGER 
	db 31, QUILAVA,    FLAME_WHEEL, SMOKESCREEN, EMBER, THUNDERSHOCK
	db -1 ; end
	...
	db 33, GOLBAT,      LEECH_LIFE, WING_ATTACK, BITE, CONFUSE_RAY
	db 32, 	PERSIAN,	BITE, PAY_DAY, SWIFT, SWAGGER 
	db 31, CROCONAW,   DIG, KARATE_CHOP, SURF, CRUNCH
	db -1 ; end
...
WillGroup:
	...
	db 58, MR__MIME,	FOCUS_BAND, LIGHT_SCREEN, REFLECT, PSYCHIC_M, SWAGGER
	db 58, ESPEON,		TWISTEDSPOON, PSYCHIC_M, SHADOW_BALL, HYPNOSIS, DREAM_EATER
	db 58, MEGANIUM,	MIRACLEBERRY, EARTHQUAKE, BODY_SLAM, SYNTHESIS, SWORDS_DANCE
	db 58, EXEGGUTOR,	LEFTOVERS, STUN_SPORE, LEECH_SEED, EXPLOSION, PSYCHIC_M
	db 58, SLOWKING,    MYSTIC_WATER, CURSE, AMNESIA, SURF, PSYCHIC_M
	db 59, XATU,		SHARP_BEAK, PSYCHIC_M, DRILL_PECK, HAZE, STEEL_WING
	db -1 ; end
...
BrunoGroup:
	...
	db 60, HITMONCHAN,	QUICK_CLAW, THUNDERPUNCH, ICE_PUNCH, FIRE_PUNCH, MACH_PUNCH
	db 60, HITMONLEE,	BLACKBELT_I, SWAGGER, DOUBLE_KICK, HI_JUMP_KICK, MEDITATE
	db 60, TYRANITAR,	HARD_STONE, CURSE, ANCIENTPOWER, CRUNCH, EARTHQUAKE
	db 60, HERACROSS,	SILVERPOWDER, MEGAHORN, REVERSAL, EARTHQUAKE, ROCK_SLIDE
	db 60, STEELIX,		SOFT_SAND, CRUNCH, EARTHQUAKE, IRON_TAIL, ROCK_SLIDE
	db 61, MACHAMP,		MIRACLEBERRY, ROCK_SLIDE, REVERSAL, VITAL_THROW, CROSS_CHOP
	db -1 ; end

KarenGroup:
	; KAREN (1)
	db "KAREN@", TRAINERTYPE_ITEM_MOVES
	db 61, GENGAR,     SPELL_TAG, SHADOW_BALL, CONFUSE_RAY, HYPNOSIS, FIRE_PUNCH
	db 61, MURKROW,    SHARP_BEAK, QUICK_ATTACK, DRILL_PECK, HAZE, FAINT_ATTACK
	db 61, UMBREON,    LEFTOVERS, SAND_ATTACK, CONFUSE_RAY, FAINT_ATTACK, TOXIC
	db 61, VILEPLUME,  MIRACLEBERRY, STUN_SPORE, GIGA_DRAIN, MOONLIGHT, PETAL_DANCE
	db 61, HOUNDOOM,   CHARCOAL, SWAGGER, PURSUIT, FLAMETHROWER, CRUNCH
	db 62, PERSIAN,		KINGS_ROCK, SWAGGER, SWORDS_DANCE, SLASH, BITE 
	db -1 ; end

KogaGroup:
	; KOGA (1)
	db "KOGA@", TRAINERTYPE_ITEM_MOVES
	db 59, FORRETRESS, FOCUS_BAND, PROTECT, TOXIC, EXPLOSION, SPIKES
	db 59, ARBOK,		QUICK_CLAW, CRUNCH, GLARE, EARTHQUAKE, TOXIC
	db 59, TENTACRUEL, MYSTIC_WATER, SURF, TOXIC, PROTECT, BARRIER
	db 59, MUK,        POISON_BARB, MINIMIZE, ACID_ARMOR, SLUDGE_BOMB, TOXIC
	db 59, ARIADOS,    SILVERPOWDER, DOUBLE_TEAM, X_SCISSOR, BATON_PASS, PSYCHIC_M
	db 60, CROBAT,     BRIGHTPOWDER, DOUBLE_TEAM, X_SCISSOR, THIEF, PROTECT
	db -1 ; end

ChampionGroup:
	; CHAMPION (1)
	db "LANCE@", TRAINERTYPE_ITEM_MOVES
	db 62, GYARADOS,	MYSTIC_WATER, DOUBLE_EDGE, RAIN_DANCE, WATERFALL, HYPER_BEAM
	db 62, AMPHAROS,	MAGNET, THUNDER_WAVE, DRAGONBREATH, THUNDER, HYPER_BEAM
	db 62, CHARIZARD,	CHARCOAL, FLAMETHROWER, FLY, FIRE_BLAST, HYPER_BEAM
	db 62, KINGDRA,		DRAGON_FANG, ICE_BEAM, OUTRAGE, WATERFALL, HYPER_BEAM
	db 62, AERODACTYL,	HARD_STONE, STEEL_WING, ANCIENTPOWER, ROCK_SLIDE, HYPER_BEAM
	db 63, DRAGONITE,	MIRACLEBERRY, EARTHQUAKE, BLIZZARD, OUTRAGE, HYPER_BEAM
	db -1 ; end
...
LassGroup:
	...
	db 28, GRANBULL,   SCARY_FACE, CHARM, HEADBUTT, ROCK_SMASH
	db -1 ; end
...
BeautyGroup:
	...
	db 26, MEOWTH,     SCRATCH, GROWL, BITE, PAY_DAY
	db 27, MEOWTH,     FAINT_ATTACK, GROWL, BITE, SLASH
	db -1 ; end
	...
	db 34, JUMPLUFF,     GIGA_DRAIN, POISONPOWDER, TACKLE, DOUBLE_EDGE
	db 34, BELLOSSOM,   ACID, RAZOR_LEAF, TACKLE, STUN_SPORE
	db -1 ; end
...
PokemaniacGroup:
	...
	db 28, LICKITUNG,  LICK, SUPERSONIC, STOMP, NO_MOVE
	db -1 ; end
...
BugCatcherGroup:
	...
	db  21, BEEDRILL,		FURY_ATTACK, POISON_STING, TWINEEDLE,FOCUS_ENERGY
	db	21, BUTTERFREE,		CONFUSION, POISONPOWDER, STUN_SPORE, SLEEP_POWDER
	db -1 ; end
...
SwimmerFGroup:
	...
	db 42, GOLDUCK,    PSYBEAM, BUBBLEBEAM, DISABLE, PSYCH_UP
	db 43, SEAKING,    PECK, SUPERSONIC, WATERFALL, HORN_ATTACK
	db -1 ; end
...
SailorGroup:
	...
	db 37, LANTURN,     SPARK, CONFUSE_RAY, WATER_GUN, FLAIL
	db 38, BLASTOISE,     BUBBLEBEAM, CURSE, BITE, BUBBLEBEAM
	db -1 ; end
...
SuperNerdGroup:
	...
	db 45, SLOWKING,   CURSE, SURF, CONFUSION, STRENGTH
	db 45, QUAGSIRE,	EARTHQUAKE, AMNESIA, CURSE, DIG
	db -1 ; end
...
BlackbeltGroup:
	...
	db 45, HITMONLEE,  DOUBLE_KICK, FORESIGHT, JUMP_KICK, FOCUS_ENERGY
	db -1 ; end
	...
	db 45, HITMONCHAN, COMET_PUNCH, THUNDERPUNCH, ICE_PUNCH, FIRE_PUNCH
	db -1 ; end

	; BLACKBELT_T (5)
	db "NOB@", TRAINERTYPE_MOVES
	db 44, MACHAMP,     VITAL_THROW, FOCUS_ENERGY, KARATE_CHOP, ROCK_SLIDE
	db 44, HERACROSS,    TAKE_DOWN, COUNTER, PIN_MISSILE, ROCK_SMASH
	db -1 ; end
...
PsychicGroup:
	...
	db 32, HYPNO,    HYPNOSIS, DISABLE, DREAM_EATER, NO_MOVE
	db 32, GIRAFARIG, STOMP, CONFUSION, AGILITY, NO_MOVE
	db -1 ; end

	; PSYCHIC_T (6)
	db "NORMAN@", TRAINERTYPE_MOVES
	db 34, SLOWBRO,   CONFUSION, WATERFALL, CURSE, DISABLE
	db 34, SLOWKING,   CURSE, BODY_SLAM, WATER_GUN, CONFUSION
	db -1 ; end
...
PicnickerGroup:
	...
	db 45, CLEFABLE,   METRONOME, SING, DOUBLESLAP, MINIMIZE
	db -1 ; end
...
ExecutiveFGroup:
	; EXECUTIVEF (1)
	db "EXECUTIVE@", TRAINERTYPE_MOVES
	db 47, ARBOK,      WRAP, POISON_STING, BITE, GLARE
	db 46, PERSIAN,		SLASH, FAINT_ATTACK, HYPNOSIS, ICY_WIND
	db 47, GLIGAR,		EARTHQUAKE, SLUDGE_BOMB, SCREECH, WING_ATTACK
	db 48, VILEPLUME,  ABSORB, PETAL_DANCE, SLEEP_POWDER, ACID
	db 49, MURKROW,    PECK, PURSUIT, HAZE, NIGHT_SHADE
	db -1 ; end
...
PokefanMGroup:
	...
	db 29, PIKACHU,     BERRY
	db 30, IVYSAUR,		BERRY
	db 30, CHARMELEON,	BERRY
	db 30, WARTORTLE, BERRY
	db -1 ; end

	; POKEFANM (2)
	db "DEREK@", TRAINERTYPE_ITEM
	db 33, RAICHU,    BERRY
	db 33, EEVEE,	 PINK_BOW
	db 33, WOOPER,	NO_ITEM
	db -1 ; end
...
KimonoGirlGroup:
	...
	db 45, FLAREON, FLAMETHROWER, SUNNY_DAY, QUICK_ATTACK, ZAP_CANNON
	db -1 ; end

	; KIMONO_GIRL (3)
	db "SAYO@", TRAINERTYPE_MOVES
	db 45, ESPEON, CONFUSION, SWIFT, ATTRACT, HIDDEN_POWER
	db -1 ; end

	; KIMONO_GIRL (4)
	db "ZUKI@", TRAINERTYPE_MOVES
	db 45, UMBREON, FAINT_ATTACK, MOONLIGHT, TOXIC, MEAN_LOOK
	db -1 ; end

	; KIMONO_GIRL (5)
	db "KUNI@", TRAINERTYPE_MOVES
	db 45, VAPOREON, AURORA_BEAM, SURF, REST, WHIRLPOOL
	db -1 ; end

	; KIMONO_GIRL (6)
	db "MIKI@", TRAINERTYPE_MOVES
	db 45, JOLTEON, THUNDER_WAVE, THUNDERSHOCK, HIDDEN_POWER, NO_MOVE
	db -1 ; end
...
TwinsGroup:
	...
	db 32, CLEFABLE,   GROWL, ENCORE, DOUBLESLAP, METRONOME
	db 32, WIGGLYTUFF, SING, DEFENSE_CURL, HEADBUTT, DISABLE
	db -1 ; end
...
PokefanFGroup:
	...
	db 29, PERSIAN,   BERRY
	db 28, ESPEON, MINT_BERRY
	db -1 ; end

	; POKEFANF (2)
	db "RUTH@", TRAINERTYPE_ITEM
	db 34, MR__MIME,	TWISTEDSPOON
	db 34, MACHAMP,    BERRY
	db -1 ; end
...
GruntFGroup:
	...
	db 48, ARBOK,		WRAP, LEER, POISON_STING, BITE
	db 48, VILEPLUME,	ABSORB, MOONLIGHT, STUN_SPORE, SLEEP_POWDER
	db 48, PARASECT,	SLASH, LEECH_LIFE, CURSE, STUN_SPORE
	db -1 ; end

MysticalmanGroup:
	; MYSTICALMAN (1)
	db "EUSINE@", TRAINERTYPE_MOVES
	db 43, HYPNO,    DREAM_EATER, HYPNOSIS, DISABLE, CONFUSION
	db 43, NOCTOWL,    WING_ATTACK, HYPNOSIS, CONFUSION, DREAM_EATER
	db 44, URSARING,	HEADBUTT, CURSE, DIG, FIRE_PUNCH
